 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GetPolicyNoPIResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "GetPolicyNoPIResponse")
public class GetPolicyNoPIResponse {

    @XmlElementRef(name = "GetPolicyNoPIResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> getPolicyNoPIResult;
    ...
    /**
     * Gets the value of the getPolicyNoPIResult property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getGetPolicyNoPIResult() {
        return getPolicyNoPIResult;
    }

    /**
     * Sets the value of the getPolicyNoPIResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setGetPolicyNoPIResult(JAXBElement<String> value) {
        this.getPolicyNoPIResult = value;
    }
