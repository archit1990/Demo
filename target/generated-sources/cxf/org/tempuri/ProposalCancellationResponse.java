 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ProposalCancellationResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ProposalCancellationResponse")
public class ProposalCancellationResponse {

    @XmlElementRef(name = "ProposalCancellationResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> proposalCancellationResult;
    ...
    /**
     * Gets the value of the proposalCancellationResult property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getProposalCancellationResult() {
        return proposalCancellationResult;
    }

    /**
     * Sets the value of the proposalCancellationResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setProposalCancellationResult(JAXBElement<String> value) {
        this.proposalCancellationResult = value;
    }
