 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FetchProposalXmlResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "fetchProposalXmlResult",
    "objServiceResult"
})
@XmlRootElement(name = "FetchProposalXmlResponse")
public class FetchProposalXmlResponse {

    @XmlElementRef(name = "FetchProposalXmlResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fetchProposalXmlResult;
    ...
    /**
     * Gets the value of the fetchProposalXmlResult property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getFetchProposalXmlResult() {
        return fetchProposalXmlResult;
    }

    /**
     * Sets the value of the fetchProposalXmlResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setFetchProposalXmlResult(JAXBElement<String> value) {
        this.fetchProposalXmlResult = value;
    }
