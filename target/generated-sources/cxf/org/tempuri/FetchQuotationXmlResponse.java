 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FetchQuotationXmlResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    "fetchQuotationXmlResult",
    "objServiceResult"
})
@XmlRootElement(name = "FetchQuotationXmlResponse")
public class FetchQuotationXmlResponse {

    @XmlElementRef(name = "FetchQuotationXmlResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fetchQuotationXmlResult;
    ...
    /**
     * Gets the value of the fetchQuotationXmlResult property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getFetchQuotationXmlResult() {
        return fetchQuotationXmlResult;
    }

    /**
     * Sets the value of the fetchQuotationXmlResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setFetchQuotationXmlResult(JAXBElement<String> value) {
        this.fetchQuotationXmlResult = value;
    }
